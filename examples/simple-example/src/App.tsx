      ...
      < div className="Main">
        <table>
          <tbody>
            <tr>
              <td>
                <WorldMap color="red" tooltipBgColor={"blue"} title="Top 10 Populous Countries" value-suffix="people" size="sm" data={data1} border={true}/>
              </td>
              <td>
                <WorldMap color="green" tooltipBgColor={"purple"} title="Top 10 GDP per Capita" value-prefix="$" size="md" data={data2} border={true}/>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <WorldMap color="green" tooltipBgColor={"purple"} title="Top 10 GDP per Capita" value-prefix="$" size="xl" data={data2} border={true}/>
              </td>
            </tr>
          </tbody>
        </table>
