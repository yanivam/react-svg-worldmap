...
- [ ] T004 Confirm constitution gates and validation commands from plan.md
...
- [ ] TXXX Verify no package, build, lint, typecheck, dependency, or runtime warnings are hidden
- [ ] TXXX Run coverage validation and confirm thresholds remain above 80%
- [ ] TXXX Verify README/package artifacts and release notes impact
- [ ] TXXX Run geopolitical neutrality review for any map data, country, territory, or boundary changes
...
- Tests MUST be written and FAIL before implementation for code-bearing changes
